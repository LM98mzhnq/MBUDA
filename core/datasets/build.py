...
def build_dataset(cfg, mode='train', is_source=True, epochwise=False,index=0):
    ...
    if mode=='train':
        ...
        if is_source:
            ...
            if index == 0:
                ...
                dataset = DatasetCatalog.get(cfg.DATASETS.TARGET_TRAIN1, mode, num_classes=cfg.MODEL.NUM_CLASSES, max_iters=iters, transform=transform)
    elif mode=='val':
        ...
        if index == 0:
            ...
            dataset = DatasetCatalog.get(cfg.DATASETS.TEST1, cfg.DATASETS.TEST.split('_')[-1], num_classes=cfg.MODEL.NUM_CLASSES, max_iters=iters, transform=transform)
    return dataset
